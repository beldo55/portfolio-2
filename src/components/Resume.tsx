          ...
          <div className="col-lg-4">
            <div className="resume-side" data-aos="fade-right" data-aos-delay={100}>
              <div className="profile-img mb-4">
                <Image src="/assets/img/profile/profile-square-2.webp" alt="Profile" className="img-fluid rounded" width={400} height={400} />
              </div>
          ...
          <div className="col-lg-8 ps-4 ps-lg-5">
            ...
            <div className="resume-section" data-aos="fade-up">
              ...
              <div className="resume-item">
                ...
                <ul>
                  <li>Spearheaded development of company&lsquo;s flagship product reaching 1M+ users</li>
            ...
            <div className="resume-section" data-aos="fade-up" data-aos-delay="100">
              ...
              <div className="resume-item">
                ...
                <p>Dean&lsquo;s List all semesters. Led university&lsquo;s coding club.</p>
              </div>
            </div>
